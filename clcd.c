...
{
	CLCD_RS = control_bit;
	CLCD_PORT = byte;   //data port(D0-D7)
	...
	do
	{
		CLCD_EN = HI;
		CLCD_EN = LO;
	} while (CLCD_BUSY);  // monitoring RD7

        /*Write operation for next step of data*/
	CLCD_RW = LO;
	PORT_DIR = OUTPUT;
}
